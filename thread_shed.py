#Showing how to see how many of each color was sold in a day at the shop!
...
for x in daily_transactions:
  x = x.split(":)")
  daily_transactions_split.append(x)
...
for color in colors:
  print(f"The store sold {color_count(color)} of {color} today!")